...
import com.skyracle.QuickParcels.Adapter.CompletedOrderAdapter;
...
public class fragment_completed  extends Fragment {
    ...
    private ArrayList<CompletedOrder> homeCategoryModelClasses;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.layout_completed, container, false);
                        ...
                        try {
                            ...
                            for (int i=0;i<array.length();i++){
                                ...
                                if (status.equals("4")){
                                    ...
                                    CompletedOrder mylist=new CompletedOrder(
                                            object.getString("date"),
                                            object.getString("time"),
                                            pickup,
                                            drop,
                                            object.getString("pdf_name"),
                                    ...
                                    if (homeCategoryModelClasses.size()>0) {
                                        ...
                                        adapter = new CompletedOrderAdapter(getActivity(), homeCategoryModelClasses);
