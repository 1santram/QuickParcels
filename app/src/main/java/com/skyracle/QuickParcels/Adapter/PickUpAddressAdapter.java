...
public class PickUpAddressAdapter extends RecyclerView.Adapter<PickUpAddressAdapter.MyViewHolder> {
    ...
    Context context;
    private List<PickupAddress> OfferList;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView addresstype,name,flat,street,city,mobile,state,addressid,pincode,nearby;
    ...
    public PickUpAddressAdapter(Context context, List<PickupAddress> offerList) {
        this.OfferList = offerList;
        this.context = context;
    }

    @Override
    public PickUpAddressAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_addedaddress, parent, false);


        return new PickUpAddressAdapter.MyViewHolder(itemView);


    }

    @Override
    public void onBindViewHolder(@NonNull PickUpAddressAdapter.MyViewHolder holder, final int position) {
        final PickupAddress lists = OfferList.get(position);
