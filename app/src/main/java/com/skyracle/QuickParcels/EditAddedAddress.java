...
public class EditAddedAddress extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_added_address);
    ...
    private void showAddressInfo() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST,Urls,
            ...
            protected Map<String,String> getParams()
            {
                ...
                String userid=Utils.getSavedPreferences(EditAddedAddress.this,Hom.userid,"");
        ...
        RequestQueue requestQueue= Volley.newRequestQueue(EditAddedAddress.this);
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (msg.equals("DATA UPDATE SUCCESSFULLY")){
                                Intent intent=new Intent(EditAddedAddress.this,Hom.class);
                                intent.putExtra("FromReservation", "5");
                                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK|Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                startActivity(intent);
                            }else{
                                Toast.makeText(EditAddedAddress.this, "Server Problem", Toast.LENGTH_SHORT).show();
                            }
